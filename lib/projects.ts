...
export const projects: Project[] = [
  {
    ...
    timeline: "2024",
    tools: "PowerPoint, Data Visualization, Slide Design",
    client: "Brenau University · Mass Culture",
    heroDescription:
  ...
  },
  {
    ...
    variant: "culture",
    name: "CICU End of Year Showcase",
    ...
    description:
      "Supported the planning and promotion of the annual End of Year Showcase for the Creative Industries Student Union (CICU) to build excitement and drive attendance. Created promotional graphics, coordinated social media countdown campaigns, supported ticket sales, and captured live event photography to document the student experience across CICU’s digital channels.",
    media: {
      type: "image",
      src: "/assets/cicu/showcase/showcase-post-1.jpg",
      gradient: "linear-gradient(135deg, #FF007F 0%, #FF5F1F 100%)",
      alt: "Creative Industries Student Union End of Year Showcase",
    },
    role: "Co-VP of Marketing & Creative Director",
    timeline: "2023 — 2025",
    tools: "Social Media Analytics, Canva, Adobe Creative Cloud, Event Photography",
    client: "Creative Industries Student Union (CICU)",
    heroDescription:
